...
const Main = () => {
  ...
  return (
    <div className="lg:flex  ">
      ...
      <div className="p-5 absolute sm:p-8 lg:p-[15%] lg:pt-0 lg:flex">
        <div className="flex flex-col-reverse">
          <div className="lg:mt-[20%] lg:ml-[10%]">
            <img className="-mt-[70%] w-[80%] ml-[20%] lg:m-0 " src={cardImg} />
            <h1 className="ml-[77%] text-white -mt-[26%] lg:ml-[65%] ">
              {cvc}
            </h1>
          </div>
          <div className="">
            ...
            <div className="-mt-[43%] p-3 w-[75%] sm:p-8">
              <img src={logo} />
              <h1 className="text-white mt-[5%] tracking-widest">{cardNumber}</h1>
